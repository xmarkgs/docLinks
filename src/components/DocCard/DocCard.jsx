...
class DocCard extends Component {
    ...
    render() {
        const { title, doc, visible, loading = this.state } = this.state;
        ...
        return (
            <>
                <div className="table-doc-title-wrap">
                    <img src={doc.type === "document" ? "/Docs.svg" : doc.type === "presentation" ? "/Slides.svg" : "Sheets.svg"}></img>
